...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'haru-starter' ),
			'defaultString' => esc_html__( 'Default', 'haru-starter' ),
			'pick'          => esc_html__( 'Select Color', 'haru-starter' ),
			'current'       => esc_html__( 'Current Color', 'haru-starter' ),
		) );
	}
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'haru-starter' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'haru-starter' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'haru-starter' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'haru-starter' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'haru-starter' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'haru-starter' ) ),
					'nextText'        => esc_html__( 'Next', 'haru-starter' ),
					'prevText'        => esc_html__( 'Prev', 'haru-starter' ),
					'currentText'     => esc_html__( 'Today', 'haru-starter' ),
					'closeText'       => esc_html__( 'Done', 'haru-starter' ),
					'clearText'       => esc_html__( 'Clear', 'haru-starter' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'haru-starter' ),
					'timeText'      => esc_html__( 'Time', 'haru-starter' ),
					'hourText'      => esc_html__( 'Hour', 'haru-starter' ),
					'minuteText'    => esc_html__( 'Minute', 'haru-starter' ),
					'secondText'    => esc_html__( 'Second', 'haru-starter' ),
					'currentText'   => esc_html__( 'Now', 'haru-starter' ),
					'closeText'     => esc_html__( 'Done', 'haru-starter' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'haru-starter' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'haru-starter' ),
				'upload_files' => esc_html__( 'Use these files', 'haru-starter' ),
				'remove_image' => esc_html__( 'Remove Image', 'haru-starter' ),
				'remove_file'  => esc_html__( 'Remove', 'haru-starter' ),
				'file'         => esc_html__( 'File:', 'haru-starter' ),
				'download'     => esc_html__( 'Download', 'haru-starter' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'haru-starter' ),
			),
		);
