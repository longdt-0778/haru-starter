...
if ( !class_exists( 'ReduxFramework_extension_wbc_importer' ) ) {
    ...
    class ReduxFramework_extension_wbc_importer {
            ...
            if ( isset( $_REQUEST['type'] ) && $_REQUEST['type'] == "import-demo-content" && array_key_exists( $_REQUEST['demo_import_id'], $this->wbc_import_files ) ) {
                ...
                if ( file_exists( $demo_data_loc.'/'.$import_parts['content_file'] ) && is_file( $demo_data_loc.'/'.$import_parts['content_file'] ) ) {
                    ...
                    if ( !isset( $import_parts['imported'] ) || true === $reimporting ) {
                        ...
                        echo esc_html__( "Demo Already Imported", 'haru-starter' );
                    }
                }
        ...
        function add_importer_section() {
            ...
            $wbc_importer_label = trim( esc_html( apply_filters( 'wbc_importer_label', __( 'Demo Importer', 'haru-starter' ) ) ) );

            $wbc_importer_label = ( !empty( $wbc_importer_label ) ) ? $wbc_importer_label : __( 'Demo Importer', 'haru-starter' );

            $this->parent->sections[] = array(
                'id'     => 'wbc_importer_section',
                'title'  => $wbc_importer_label,
                'desc'   => '<p class="description">'. apply_filters( 'wbc_importer_description', esc_html__( 'Works best to import on a new install of WordPress', 'haru-starter' ) ).'</p>',
            ...
            $this->parent->sections[] = array(
                'title'      => esc_html__( 'Maintenance Mode', 'haru-starter' ),
                'desc'       => '',
                'subsection' => false,
                ...
                'fields'     => array(
                    array(
                        ...
                        'type'     => 'button_set',
                        'title'    => esc_html__( 'Maintenance Mode', 'haru-starter' ),
                        'subtitle' => esc_html__( 'Enable/Disable your site maintenance mode.', 'haru-starter' ),
                        'desc'     => '',
                        'options'  => array(
                            '1' => 'On',
                            '0' => 'Off',
                    ...
                    array(
                        ...
                        'title'       => esc_html__('Maintenance title', 'haru-starter'),
                        'subtitle'    => esc_html__('Insert coming soon title.', 'haru-starter'),
                    ...
                    array(
                        ...
                        'url'      => true,
                        'required' => array('enable_maintenance', '=', '1'),
                        'title'    => esc_html__('Maintenance Background', 'haru-starter'),
                        'subtitle' => esc_html__('Select maintenance background image.', 'haru-starter'),
                        'desc'     => '',
                        'default'  => '',
                        'args'     => array()
                    ),
                    array(
                        ...
                        'required'    => array('enable_maintenance', '=', '1'),
                        'title'       => esc_html__( 'Online time', 'haru-starter' ),
                        'subtitle'    => esc_html__( 'Your page will automatic end maintenance mode after this time.', 'haru-starter' ),
                    ),
                    array(
                        'id'          => 'timezone',
                        'type'        => 'text',
                        ...
                        'required'    => array('enable_maintenance', '=', '1'),
                        'title'       => esc_html__('Timezone', 'haru-starter'),
                        'subtitle'    => esc_html__('You can change timezone from here. More details: http://php.net/manual/en/timezones.php', 'haru-starter'),
                    ...
                    array(
                        ...
                        'required' => array('enable_maintenance', '=', '1'),
                        'width'    => '100%',
                        'title'    => esc_html__('Maintenance social profiles', 'haru-starter'),
                        'subtitle' => esc_html__('Select social profile for maintenance page.', 'haru-starter'),
                        'options'  => array(
                            'twitter'    => esc_html__( 'Twitter', 'haru-starter' ),
                            'facebook'   => esc_html__( 'Facebook', 'haru-starter' ),
                            'vimeo'      => esc_html__( 'Vimeo', 'haru-starter' ),
                            'linkedin'   => esc_html__( 'LinkedIn', 'haru-starter' ),
                            'googleplus' => esc_html__( 'Google+', 'haru-starter' ),
                            'flickr'     => esc_html__( 'Flickr', 'haru-starter' ),
                            'youtube'    => esc_html__( 'YouTube', 'haru-starter' ),
                            'pinterest'  => esc_html__( 'Pinterest', 'haru-starter' ),
                            'instagram'  => esc_html__( 'Instagram', 'haru-starter' ),
                            'behance'    => esc_html__( 'Behance', 'haru-starter' ),
                        ),
                        'desc'    => '',
                        'default' => ''
                    ),
        ...
        *************************************************************************/
        ...
        function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
            ...
            *************************************************************************/
            ...
            // If it's demo1 - demo6
            $wbc_menu_array = array( 'home1', 'home2', 'home3', 'home4', 'home5' );
