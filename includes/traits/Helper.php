...
namespace Haru_Starter\Traits;

if (!defined('ABSPATH')) {
    exit;
} // Exit if accessed directly

use \Haru_Starter\Classes\Helper as HelperClass;
use \Haru_Starter\Elements\Woo_Checkout;
...
trait Helper
{
    ...
    public function ajax_load_more()
    {
        ...
        if ($class == '\Haru_Starter\Elements\Post_Grid' && $settings['orderby'] === 'rand') {
        ...
        if ($template_info) {
            ...
            if ($file_path) {
                ...
                if ($query->have_posts()) {
                    ...
                    if($class === '\Haru_Starter\Pro\Elements\Post_List') {
