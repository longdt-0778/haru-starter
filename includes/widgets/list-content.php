	        ...
	        $this->add_control(
				...
				[
					...
					'options' => [
						...
						'style-3' 	=> __( 'Pre List Content 3', 'haru-starter' ),
					]
				]
			);
					...
					<ul>
						<?php foreach (  $settings['list'] as $item ) : ?>
							<li>
								...
								<?php elseif ( in_array( $settings['pre_style'], array( 'style-3' ) ) ) : ?>
								<div class="haru-list-content__icon"><i class="haru-icon haru-arrow-down"></i></div>
								<?php endif; ?>
