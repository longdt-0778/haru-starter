        		...
        		<div class="haru-meaning__wrap" style="background-image: url(<?php echo esc_url( $settings['image_bg']['url'] ); ?>);">
					...
					<div class="haru-meaning__content">
						...
						<div class="haru-meaning__btn">
							<a href="#meaning-popup-<?php echo esc_attr( $this->get_id() ); ?>" class="haru-meaning__click haru-button haru-button--text haru-button--text-white"><?php echo $settings['btn_text']; ?><i class="haru-icon haru-arrow-right"></i></a>
						</div>
					</div>
				</div>
