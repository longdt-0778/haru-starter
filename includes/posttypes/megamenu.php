...
if ( !class_exists( 'Haru_MegaMenu_Post_Type' ) ) {
    class Haru_MegaMenu_Post_Type {
        ...
        public function haru_megamenu() {
            $labels = array(
                'menu_name'          => esc_html__( 'MegaMenu Builders', 'haru-starter' ),
                'singular_name'      => esc_html__( 'MegaMenu', 'haru-starter' ),
                'name'               => esc_html__( 'All MegaMenu', 'haru-starter' ),
                'add_new'            => esc_html__( 'Add New', 'haru-starter' ),
                'add_new_item'       => esc_html__( 'Add New MegaMenu', 'haru-starter' ),
                'edit_item'          => esc_html__( 'Edit MegaMenu', 'haru-starter' ),
                'new_item'           => esc_html__( 'Add New MegaMenu', 'haru-starter' ),
                'view_item'          => esc_html__( 'View MegaMenu', 'haru-starter' ),
                'search_items'       => esc_html__( 'Search MegaMenu', 'haru-starter' ),
                'not_found'          => esc_html__( 'No MegaMenu items found', 'haru-starter' ),
                'not_found_in_trash' => esc_html__( 'No MegaMenu items found in trash', 'haru-starter' ),
                'parent_item_colon'  => ''
            );
        ...
        public static function nav_edit_walker() {
            ...
            if ( ! class_exists( $walker ) ) {
                require_once HARU_STARTER_CORE_DIR . '/includes/classes/class-haru-megamenu.php';
            }
        ...
        ?>
            <p class="field-icon-font description description-wide">   
                <label for="edit-menu-item-icon-font-<?php echo esc_attr( $item_id ); ?>"><?php echo esc_html__( 'Icon Font', 'haru-starter' ); ?> <br>
                    <input type="text" name="menu-item-haru_icon_font[<?php echo esc_attr( $item_id ); ?>]" value="<?php echo esc_attr( $icon_font ); ?>">
                </label>
                <br>
                <span><?php _e( 'Please click <a href="https://harutheme.com/forums/topic/list-of-font-icons-use-in-each-theme-from-harutheme/" target="_blank"> <b>here</b></a> to see the list of icons.', 'haru-starter' ); ?></span>
            </p>
            <p class="field-icon-image description description-wide">   
                <label for="edit-menu-item-icon-image-<?php echo esc_attr( $item_id ); ?>"><?php echo esc_html__( 'Icon Image', 'haru-starter' ); ?></label>
                ...
                <span><?php echo esc_html__( 'If have both Icon Font & Icon Image, Icon Image will be used.', 'haru-starter' ); ?></span>
            </p>
            ...
            <p class="field-addclass description description-wide">
                <label for="edit-menu-item-haru_mega_profile-<?php echo esc_attr( $item_id ); ?>"> 
                  <?php echo esc_html__( 'Megamenu Builder' ); ?> <br>
                    <select name="menu-item-haru_mega_profile[<?php echo esc_attr( $item_id ); ?>]">
                        <option value=""><?php echo esc_html__( 'Disable', 'haru-starter' ); ?></option>
                ...
                <a href="<?php echo  esc_url( admin_url( 'edit.php?post_type=haru_megamenu') ); ?>" target="_blank" title="<?php _e( 'Sub Megamenu Management', 'haru-starter' ); ?>"><?php _e( 'Sub Megamenu Management', 'haru-starter' ); ?></a><br>
                <span><?php _e( 'If enabled megamenu, its submenu will be disabled.', 'haru-starter' ); ?></span>
            </p>

            <p class="field-haru_width description description-thin">   
                <label for="edit-menu-item-haru_width-<?php echo esc_attr($item_id); ?>"><?php _e( 'Width', 'haru-starter' ); ?><br>
            ...
            <?php 
                $full_width = array(
                    ...
                    'container'     => __( 'Container', 'haru-starter' ),
                    'stretch'       => __( 'Stretch', 'haru-starter' ),
                ); 
            ?> 
            <p class="field-haru_full_width description description-thin">   
                <label for="edit-menu-item-haru_full_width-<?php echo esc_attr( $item_id ); ?>"><?php _e( 'Fullwidth', 'haru-starter' ); ?><br>
            ...
            <p class="field-addclass description description-wide">
                <span><?php _e( 'If have both width & Fullwidth, Fullwidth will be used.', 'haru-starter' ); ?></span>
            </p>

            <?php 
                $aligns = array(
                    'left'      => __( 'Left', 'haru-starter' ),
                    'right'     => __( 'Right', 'haru-starter' ),
                    'fullwidth' => __( 'Fullwidth', 'haru-starter' )
                ); 
            ?> 
            <!-- <p class="field-haru_alignment description description-thin">   
                <label for="edit-menu-item-haru_alignment-<?php echo esc_attr( $item_id ); ?>"><?php _e( 'Alignment:', 'haru-starter' ); ?><br>
                    <select name="menu-item-haru_alignment[<?php echo esc_attr( $item_id ); ?>]">
        ...
        ?>
            <p class="field-addclass description description-thin">
                <label for="edit-menu-item-haru_text_label-<?php echo esc_attr( $item_id ); ?>"><?php _e( 'Label', 'haru-starter' ); ?><br />
                    <input type="text" name="menu-item-haru_text_label[<?php echo esc_attr( $item_id ); ?>]" value="<?php echo esc_attr( $text_label ); ?>">
                </label>
            </p>

            <p class="field-addclass description description-thin">
                <label for="edit-menu-item-haru_text_label_color-<?php echo esc_attr($item_id); ?>"><?php _e( 'Label Color', 'haru-starter' ); ?><br /></label>
        ...
        public static function script() {
            wp_enqueue_media();
            wp_enqueue_script( 'haru-upload-image', HARU_STARTER_CORE_URL . 'assets/js/upload.js', array( 'jquery', 'wp-pointer' ), Haru_Starter::VERSION, true );
        }
    }
}
