...
class Apus_PostType_Megamenu {
  	...
  	public static function script() {
  		wp_enqueue_media();
  		wp_enqueue_script( 'apus-upload-image', HARU_STARTER_CORE_URL . 'assets/js/upload.js', array( 'jquery', 'wp-pointer' ), Haru_Starter::VERSION, true );
  	}
  	
  	public static function nav_edit_walker() {
		$walker = 'Apus_Megamenu_Config';
		if ( ! class_exists( $walker ) ) {
			require_once HARU_STARTER_CORE_DIR . '/includes/classes/class-apus-megamenu.php';
		}
