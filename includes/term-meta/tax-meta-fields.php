<?php
	...
	if ( ! function_exists( 'haru_variation_styling' ) ):
		...
		function haru_variation_styling() {
			...
			$fields[ 'color' ] = array(
				array(
					'label' => esc_html__( 'Color', 'haru-starter' ), // <label>
					'desc'  => esc_html__( 'Choose a color', 'haru-starter' ), // description
			...
			$fields[ 'image' ] = array(
				array(
					'label' => esc_html__( 'Image', 'haru-starter' ), // <label>
					'desc'  => esc_html__( 'Choose a Image', 'haru-starter' ), // description
			...
			$fields[ 'label' ] = array(
				array(
					'label' => esc_html__( 'Label', 'haru-starter' ), // <label>
					'desc'  => esc_html__( 'The text of label (should be same as name)', 'haru-starter' ), // description
