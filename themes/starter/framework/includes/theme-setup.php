...
if ( ! function_exists( 'haru_theme_setup' ) ) {
    function haru_theme_setup() {
        ...
        register_nav_menus( array(
            'primary-menu'  => esc_html__( 'Primary Menu', 'starter' ),
            'left'     => esc_html__( 'Left Menu', 'starter' ),
            'right'    => esc_html__( 'Right Menu', 'starter' ),
            'vertical' => esc_html__( 'Vertical Menu', 'starter' ),
            'onepage' => esc_html__( 'Onepage Menu', 'starter' ),
            'popup'    => esc_html__( 'Popup Menu', 'starter' ),
            'mobile'   => esc_html__( 'Mobile Menu', 'starter' ),
        ) );

        $language_path = get_template_directory() . '/languages';
        load_theme_textdomain( 'starter', $language_path );
