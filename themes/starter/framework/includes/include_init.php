...
if( !function_exists( 'haru_include_core_files' ) ) {
    function haru_include_core_files() {
        ...
        if ( file_exists( WP_PLUGIN_DIR.'/haru-starter-core/includes/scss-compiler/theme-stylesheet.php' ) ) {
            require_once( WP_PLUGIN_DIR.'/haru-starter-core/includes/scss-compiler/theme-stylesheet.php' );
        }
    }
