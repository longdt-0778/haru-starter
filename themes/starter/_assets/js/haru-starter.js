...
(function ($) {
    ...
    var HaruStarter = {
        init: function() {
            HaruStarter.base.init();
            HaruStarter.teammember.init();
        }
    };
    
    HaruStarter.base = {
        init: function() {
            HaruStarter.base.bannerCreative();
            HaruStarter.base.shortcodeImagesGallery();
            HaruStarter.base.shortcodeCounter();
            HaruStarter.base.shortcodeVideo();
            HaruStarter.base.shortcodeTestimonial();
            HaruStarter.base.contactUs();
        },
        bannerCreative: function() {
            setTimeout(function(){
                $('.banner-creative-shortcode-wrap').each(function(){
                    ...
                    HaruStarter.base.packeryPadding($this, $padding, $columns);
    ...
    HaruStarter.teammember = {
        init: function() {
            HaruStarter.teammember.shortcodeTeammember();
            HaruStarter.teammember.teammemberLoadMore();
            HaruStarter.teammember.teammemberInfiniteScroll();
        },
