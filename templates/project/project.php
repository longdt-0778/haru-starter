            ...
            <div class="project-item">
                <div class="project-item__wrap">
                    ...
                    <div class="project-item__content">
                        ...
                        <a href="<?php the_permalink(); ?>" <?php echo $target . $nofollow; ?> class="haru-button haru-button--text haru-button--text-primary"><?php echo esc_html__( 'Xem chi tiết', 'haru-starter' ); ?><i class="haru-icon haru-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        <?php endwhile; ?>
